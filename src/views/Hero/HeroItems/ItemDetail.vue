...
<!-- Clase que determina el color -->
    <div class="text-center bg-dark h-100 pt-3 d3-icon-item" :class="itemClassColor">
        <div class="d-flex flex-column justify-content-between h-100">
            <!-- Si el item tiene ID, es que tenemos la informacion -->
            ...
            <template v-if="item.id">
                ...
                <div>
                    <!-- No todos los objetos tiene gemas -->
                    ...
                    <!-- En caso de que no tenga el objeto -->
                    <p v-else>
                        <!-- Mostramos el nombre del slot y dejamos el contenido vacio -->
...
export default {
    ...
    computed: {
        ...
        // Puede haber varia Gemas, Solo puede haber una Joya. No puede haber joyas y gemas mezcladas
        gemOrJewel () {
...
.d3-icon-item
    min-height 100px
    // El bode la la caja va determinar la rareza del objeto, segun el color que tenga
